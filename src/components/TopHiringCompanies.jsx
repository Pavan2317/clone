  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Top Hiring Companies</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {companies.slice(0, 4).map((company) => (
            <div key={company.id} className="bg-gray-50 rounded-xl p-8 flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center mb-2">
                  ...
                  <span className="ml-1 text-sm text-gray-600">{company.rating} rating</span>
                </div>
